...
*/
    ...
    //                                                     {provinceName !== "" &&
    //                                                         <div>
    //                                                             <div className="backItem absolute right-[20px] top-[20px] z-50 " onClick={()=>{
    //                                                                 handleBackMap()
    //                                                             }}>
                                 ...
                                 <div>
                                    ...
                                    <div className="flex flex-row items-center justify-between">
                                       <h2 className="font-[600] text-[20px] text-[#424242]">Province & City View</h2>
                                        <div className="w-[357px] flex flex-row gap-[8px] bg-white border-[1px] border-[#e0e0e0] py-[11px] px-[12px] rounded-[4px]">
                                            <img src="./images/Asset/map/View1/search.svg" alt=""/>
                                            <input type="text" placeholder="search code site....." className="bg-none outline-none w-[100%]"/>
                                        </div>
                                    </div>
                                                            ...
                                                            <>
                                                                ...
                                                                <div className="total_map_data">
                                                                    <div className="header_total_map_data_2">
                                                                        <div className="header_total_map_data_1">
                                                                            <img
                                                                                src="./images/Asset/map/View1/total_svg.svg"
                                                                                alt=""/>
                                                                            <h2>Total statistics </h2>
                                                                            <div
                                                                     ...
                                                                     rounded-[8px]  flex flex-row items-center justify-between w-[130px] pl-[16px] pr-[16px]"
                                                                                    ...
                                                                                    <span>Total</span>
                                                                                    <img
                                                                                        src="/images/Asset/map/View1/CaretDown.svg"
                                                                                        alt=""/>
                                                                                    {siteTypesOpen && (
                                                                     ...
                                                                     rounded-[8px]  flex flex-row items-center justify-between w-[163px]">
                                                                                    <img
                                                                                        src="/images/Asset/map/View1/CalendarBlank.svg"
                                                                                        alt=""/>
                                                                        ...
                                                                        <div className="table_container_siteType"
                                                                             onClick={() => {
                                                                                 setSiteTypesOpen(!siteTypesOpen)
                                                                             }}>
                                                                            <span>Total</span>
                                                                            <img src="/images/arrow/CaretDown.svg"
                                                                                 alt=""/>
                                                                            {siteTypesOpen && (
                                                                                <div className="menuSitesOption">
                                                                                    <p>جاده ای </p>
                                                                    ...
                                                                    <div className="data_row_box">
                                                                        ...
                                                                        <div className="row_items_traffic">
                                                                            <div
                                                                                className="total_map_data_item_for_quantity_3">
                                                                                <div className="total_map_data_item_2">
                                                                                    <h3>Traffic PS</h3>
