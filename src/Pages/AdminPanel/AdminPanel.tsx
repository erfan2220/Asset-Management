  ...
  return (
      <div>
        ...
        <div className="flex flex-row">
            ...
            >
              {menu.map((item, index) => (
                  ...
                  >
                    ...
                    {item.name === "LPSM" && <EpIcon className={`${currentIndex === index ? "text-[#007BFF]" : "text-[#FFF]"}`} stroke={currentIndex === index ? "#007bff" : "#ffffff"} />}
          ...
          <div className="content-area w-[94%]">
            {menuName === "Province EP" ? <ProvinceEp /> : <AdminTable /> || menuName === "LPSM" ? <Lpsm /> : ""}
            {/* {menuName === "LPSM" ? <Lpsm /> : ""} */}
