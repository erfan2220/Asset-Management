...
import CustomSelectDropdown from "../../Components/DropDown";
      ...
      <div className="flex justify-between items-center mb-5">
        ...
        <div className="flex justify-around border-2 w-[160px] p-2 rounded-md">
          <div className="relative">
            <img src="/images/Asset/ListDashes.svg" alt="" className="bg-blue-500" />
          ...
          <div className="relative">
            <img src="/images/Asset/charts.svg" alt="" className="bg-blue-500" />
            <div className="absolute right-0 top-0 h-full border-r border-gray-300"></div>
          </div>
          <div>
            <img src="/images/Asset/matrix.svg" alt="" className="bg-blue-500" />
          </div>
        </div>
      </div>
