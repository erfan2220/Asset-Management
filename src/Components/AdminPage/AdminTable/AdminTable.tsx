                        ...
                        <div className="cursor-pointer bg-[#E5F2FF] w-full flex flex-row items-center">
                            {columns.map((item, index) => (
                                !selectedHeaders.has(item) && (
                                    <div key={index} className={`min-w-[220px] text-left py-[14px] pl-[12px] pr-[20px] whitespace-nowrap ${index === 0
                                            ? `sticky  left-0 z-10 bg-[#E5F2FF] ${isScrolled ? 'border-r-2 border-[#e0e0e0]' : ''
                                            }`
                                        ...
                                        {columns.map((header, colIndex) => {
                                            ...
                                            if (header === "Asset") {
                                                return (
                                                    <td
                                                        key={colIndex}
                                                        className={`sticky left-0 z-10 bg-white min-w-[220px] flex flex-row items-center gap-[22px] border-b-[1px] border-b-[#e0e0e0] py-[14px] pl-[12px] ${isScrolled ? 'border-r-2 border-[#e0e0e0]' : ''
                                                            }`}
                                                    >
                                                        <input
                                                            type="checkbox"
