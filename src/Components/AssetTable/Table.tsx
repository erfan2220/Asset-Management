    ...
    return (
        ...
        <div className="relative">
            <div className="flex justify-between items-center mb-8 ml-[20px]">
                ...
                <div className={`relative bg-white flex flex-row items-center rounded-[4px] ${exportOpen ? "border-[1px] border-[#63ABFD]" : "border-[1px]"
                    }`}
                    ...
                    <div ref={tableRef}
                        ...
                        <div className="flex flex-row items-center justify-between
                            ...
                            <div className=" w-[316px] flex flex-row items-center
                                ...
                                <input className="outline-none bg-transparent border-none w-full h-full" type="text" placeholder={t("search here")}
                        ...
                        <div className="cursor-pointer bg-[#E5F2FF] w-full flex flex-row items-center">
                            {tabHeaders.map((item, index) => (
                                !selectedHeaders.has(item) && (
                                    <div key={index} className={` text-left py-[14px] pl-[12px] pr-[20px] whitespace-nowrap ${index === 0
                                            ? `sticky  left-0 z-10 bg-[#E5F2FF] ${isScrolled ? 'border-r-[2px] border-[#e0e0e0]' : ''
                                            }`
                                    ...
                                    <tr className="cursor-pointer" key={rowIndex} onClick={() => handleNavigate()}>
                                        {tabHeaders.map((header, colIndex) => {
                                            ...
                                            if (header === "assetName") {
                                                ...
                                                border-b-[1px] border-b-[#e0e0e0] py-[14px] pl-[12px] ${isScrolled ? 'border-r-2 border-[#e0e0e0]' : ''
                                                            }`}
                                                        style={{
                                                            width: `calc(100%/${tabHeaders.length})`,
                                                            maxWidth: '286px',
