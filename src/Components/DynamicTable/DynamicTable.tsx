...
import DynamicNames from "../../database/DynamicApiAssetCategories/DynamicNames";
...
// Function to trigger the CSV download
    ...
    return (
        <div className="relative w-full mt-[20px] mr-[20px]">
                    ...
                    <div ref={tableRef}
                        ...
                        <div className="flex flex-row items-center justify-between
                            ...
                            <div className="flex flex-row items-center gap-[12px]">
                                <div
                                    className={filterType === 1 ? "flex justify-center items-center w-[40px] h-[40px] bg-[#E5F2FF]" : "cursor-pointer"}
                                    onClick={() => handleFilterType(1)}>
                                    <img src="/images/Asset/filterIcon.svg" alt=""/>
                                </div>

                                <div
                                    className={filterType === 2 ? "flex justify-center items-center w-[40px] h-[40px] bg-[#E5F2FF]" : "cursor-pointer"}
                        ...
                        <div className="cursor-pointer bg-[#E5F2FF] w-full flex flex-row items-center">
                            {tabHeaders.map((item, index) => (
                                !selectedHeaders.has(item) && (
                                    <div key={index}
                                         className={` text-left py-[14px] pl-[12px] pr-[20px] whitespace-nowrap ${
                                             index === 0
